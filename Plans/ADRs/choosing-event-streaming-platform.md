...
While designing CoList architecture, it was becoming clear that I need a way of managing event streams. I have identified two types of event streaming technology that are commonly used: message broker, and streaming platform.

A message broker is a . Examples include MySQL, PostgreSQL, and Oracle.
...
Event databases store data as a series of events, capturing every change to the data. They are suitable for applications that require auditing, event sourcing, and complex data processing. Examples include Apache Kafka, Apache Pulsar, and AWS Kinesis. Decision
